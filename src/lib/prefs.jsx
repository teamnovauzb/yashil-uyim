...
const DICT = {
  uz: {
    ...
    whatAtFestival: "Festivalda ishtirok eting!",
    ...
    aboutUs: 'Yashil Uyim haqida', instagramOurs: 'Galereya', festivalMoments: 'Festival lahzalari', followUs: 'Kuzatib boring',
  ...
  ru: {
    ...
    whatAtFestival: 'Участвуй в фестивале!',
    ...
    aboutUs: 'О Yashil Uyim', instagramOurs: 'Галерея', festivalMoments: 'Моменты фестиваля', followUs: 'Подписаться',
  ...
  en: {
    ...
    whatAtFestival: "Join the festival!",
    ...
    aboutUs: 'About Yashil Uyim', instagramOurs: 'Gallery', festivalMoments: 'Festival moments', followUs: 'Follow us',
